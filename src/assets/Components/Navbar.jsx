...
const Navbar = ({home}) => {
  ...
  return (
  <div className=' Dyn-nav' style={{
    width:"100%", height:"100%"
  }}>
    
    <div className='com1 display gap-sm-1 bg-warning h-auto' >
      <p className='style com1 ps-2 mb-0'>We are one of Top Event Management Companies in Pakistan</p>
