...
setIndex(prev => (prev + 1) % total);
  ...
  return (
        ...
        <div className="position-relative slider-class border border-danger  " style={{ boxShadow: '0 7px 8px rgba(209, 117, 42, 0.2)', height: '600px', overflow: 'hidden', marginBottom:'50px'}}>
