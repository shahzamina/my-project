...
const Packcom = () => {
  ...
  return (     
    ...
    <div className='p-class ms-md-5 your-class d-flex flex-md-row gap-3' style={{marginBottom:'60px',marginTop:'50px',height: "100%"}}>
      {Package.map((item)=>(
        <div className="p-class pack-class Card-image  ms-sm-1  shadow" key={item.id}  style={{  marginTop:'20px',  maxWidth:"500px"}}>
